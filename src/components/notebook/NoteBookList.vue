<template>
  <v-container>
    <v-list :color="app_data.theme_color.card_bg" dense rounded>
      <v-list-item @click="new_notebook">
        <v-icon :color="app_data.theme_color.content"> mdi-plus </v-icon>
        <span :style="`color:${app_data.theme_color.content}`" class="ml-3">
          Add New Notebook
        </span>
      </v-list-item>
